...
CREATE POLICY "Allow Authenticated user  to selecte" ON "public"."order_items" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "Allow Authenticated user  to selecte" ON "public"."orders" USING (true) WITH CHECK (true);



CREATE POLICY "Allow Authenticated user  to selecte" ON "public"."products" TO "authenticated" USING (true);
